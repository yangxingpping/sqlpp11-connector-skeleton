// generated by .\ddl2cpp .\sample.sql ./demo/demo hhhhh
#ifndef HHHHH_DEMO_H
#define HHHHH_DEMO_H
...
namespace hhhhh
{
    ...
    struct Psi
    {
      struct _alias_t
      {
        ...
        struct _member_t
          {
            T psi;
            T& operator()() { return psi; }
            const T& operator()() const { return psi; }
          };
      };
    ...
    struct Book
    {
      struct _alias_t
      {
        ...
        struct _member_t
          {
            T book;
            T& operator()() { return book; }
            const T& operator()() const { return book; }
          };
      };
    ...
    struct ColDayPoint
    {
      struct _alias_t
      {
        ...
        struct _member_t
          {
            T colDayPoint;
            T& operator()() { return colDayPoint; }
            const T& operator()() const { return colDayPoint; }
          };
      };
    ...
    struct ColTimePoint
    {
      struct _alias_t
      {
        ...
        struct _member_t
          {
            T colTimePoint;
            T& operator()() { return colTimePoint; }
            const T& operator()() const { return colTimePoint; }
          };
      };
    ...
    struct ColTimeOfDay
    {
      struct _alias_t
      {
        ...
        struct _member_t
          {
            T colTimeOfDay;
            T& operator()() { return colTimeOfDay; }
            const T& operator()() const { return colTimeOfDay; }
          };
      };
  ...
  struct TabDateTime: sqlpp::table_t<TabDateTime,
               TabDateTime_::ColDayPoint,
               TabDateTime_::ColTimePoint,
               TabDateTime_::ColTimeOfDay>
  {
    struct _alias_t
    {
